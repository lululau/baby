...
function testArraySubarr_with_zero_length() {
...
function testArraySubarr_with_negative_length() {
    ...
    assertEquals "$expected" "$b_repr"
    unset b b_repr
    arr.subarr b 4 -100 "a"
    b_repr=$(arr.print b)
    assertEquals "$expected" "$b_repr"
    unset b b_repr
    arr.subarr b 5 -9999999 "a"
    b_repr=$(arr.print b)
    assertEquals "$expected" "$b_repr"
}

function testArraySubarr_with_length_out_of_index() {
